We have used ViZDoom Library from following repo([https://github.com/Farama-Foundation/ViZDoom](url)) so that we don't have to take hassle of creating the game environment.
